...
<form method="post" action=" <?php echo $_SERVER['PHP_SELF'];?>">
		Name: <input type = "text" name = "nume1">
        <br>
		Prenume: <input type = "text" name = "prenume1">
        <br>
		Sex: <input type = "text" name = "sexul">
        <br>
		CNP: <input type = "text" name = "cod_numeric1">
        <br>
		Strada: <input type = "text" name = "strada">
        <br>
		NrTel: <input type = "text" name = "nrtel">
        <br>		
		<input  type = "submit" value="Adauga">
	</form><br></br>
		<a href="Afisare_pacienti.php">Afisare pacienti</a> <br></br>
