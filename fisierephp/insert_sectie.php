...
<div class="row">
<div class="side">
<h2>Adaugati o sectie?</h2>

<form method="post" action=" <?php echo $_SERVER['PHP_SELF'];?>">
		Name: <input type = "text" name = "nume2">
        <br>
		<input  type = "submit" value="Adauga">
	</form><br></br>
	<a href="menu.php">Intoarcere la meniu!</a> <br></br>
			<a href="afisare_sectie2.php">Afisare sectii</a> <br></br>

</div>
 <div class="main">
    <h2></h2>
     <div> <img src="sectie.jpg" alt="sectie" width="800" height="400"></div>
    <br>
</body>
</html>
