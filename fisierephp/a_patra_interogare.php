...
<div class="row">
<div class="side">
	<a href="interogare2.php">Intoarcere la interogare!</a> <br></br>
</div>
 <div class="main">
    <h2></h2>
    <br>
...
#cautam ce alergii are un pacient
...
echo 'Alergiile de care sufera pacientul ', $nume3 ,' sunt :' ; 
echo '<br>';
while($rand = sqlsrv_fetch_array ($result)){
echo $rand['NumeAlergie'];
