...
<div class="row">
<div class="side">
	<a href="interogare2.php">Intoarcere </a> <br></br>
</div>
 <div class="main">
    <h2></h2>
    <br>
...
#aflam cei mai alergici pacienti 

$query = "select top 1 p.Nume, p.Prenume
From Pacient P join [Alergie pacient] ap on ap.IdPacient = p.IdPacient
group by p.IdPacient ,p.Nume, p.Prenume";



$result = sqlsrv_query($conn, $query);  
echo 'Cei mai alergici pacienti  sunt :' ; 
echo '<br>';
