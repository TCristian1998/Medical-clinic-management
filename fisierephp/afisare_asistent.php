...
<div class="row">
<div class="side">
	<a href="update_a.php">Intoarcere la modifica Asistent</a> <br></br>
</div>
 <div class="main">
    <h2></h2>
    <br>
...
#Interogare de afisare toti asistentilor

$query = "SELECT A.Nume,' ', A.Prenume, A.Salariu FROM Asistent A";
$result = sqlsrv_query($conn, $query); 
echo 'Asistentii sunt :' ; 
echo '<br>';
