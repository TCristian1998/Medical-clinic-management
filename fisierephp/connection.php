...
<div class="side">
    <h2>Conecteaza-te</h2>
   <!--Luam cu ajutorul butoanelor numele utilizatorului si parola -->
<form method="post" action=" <?php echo $_SERVER['PHP_SELF'];?>">
		Name: <input type = "text" name = "utilizator">
        <br>
  ...
  <div class="main">
    <h2>Doctori fericiti</h2>
     <div> <img src="doctori.jpg" alt="Doctor" width="500" height="400"></div>
    <br>
