...
<div class="row">
<div class="side">
	<a href="sterge2.php">Intoarcere la stergere echipament</a> <br></br>
</div>
 <div class="main">
    <h2></h2>
    <br>
...
$query = "SELECT E.NumeEchipament FROM Echipamente E ";
$result = sqlsrv_query($conn, $query); 
echo 'Echipamentele sunt :' ; 
echo '<br>';
while($rand = sqlsrv_fetch_array ($result)){
echo $rand['NumeEchipament'];
echo '<br>';
}
